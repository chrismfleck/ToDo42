#!/bin/bash
# Find every ToDo42 checkout, sync THIS one to Build 151, close Xcode, open the right project.
set -euo pipefail
...
echo "  • Product → Run"
echo
echo "PROOF YOU GOT 151:"
echo "  1. In-app bottom label:   Build 151"
echo "  2. Xcode console:         >>> Save4Two AppBuild 151 SRC <<<"
echo
