#!/bin/bash
# Find every ToDo42 checkout, sync THIS one to Build 144, close Xcode, open the right project.
set -euo pipefail
...
echo "  • Product → Run"
echo
echo "PROOF YOU GOT 144:"
echo "  1. In-app bottom label:   Build 144"
echo "  2. Xcode console:         >>> Save4Two AppBuild 144 SRC <<<"
echo
