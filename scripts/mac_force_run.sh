#!/bin/bash
# Find every ToDo42 checkout, sync THIS one to Build 148, close Xcode, open the right project.
set -euo pipefail
...
echo "  • Product → Run"
echo
echo "PROOF YOU GOT 148:"
echo "  1. In-app bottom label:   Build 148"
echo "  2. Xcode console:         >>> Save4Two AppBuild 148 SRC <<<"
echo
