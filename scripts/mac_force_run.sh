#!/bin/bash
# Find every ToDo42 checkout, sync THIS one to Build 143, close Xcode, open the right project.
set -euo pipefail
...
echo "  • Product → Run"
echo
echo "PROOF YOU GOT 143:"
echo "  1. In-app bottom label:   Build 143"
echo "  2. Xcode console:         >>> Save4Two AppBuild 143 SRC <<<"
echo
