...
expect(instagram.contains("google.com/search"), "instagram search keeps all tags")
...
expect(instagram.contains("site:instagram.com") || instagram.contains("site%3Ainstagram.com"), "instagram scoped")
